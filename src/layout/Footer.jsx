...
function Footer() {
  return (
    <>
      <footer className="bg-[#002e74] shadow md:flex md:items-center md:justify-between md:p-3 dark:bg-gray-800  font-signika">
        <div className="grid grid-rows-2 mx-auto">
          <div className="mx-auto">
            <span className="text-sm  text-white sm:text-center dark:text-gray-400">© Coppyright © 2022 - KSB Smart. All Rights Reserved.</span>
          </div>
